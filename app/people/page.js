...
const People = () => {
  return (
    <div className='space-y-14'>
        <CustomHeader title="Our People" justify="items-center" />
        <PeopleHeading />
        <div className='flex flex-col lg:gap-y-40  min-h-60 bg-gray-100 lg:px-16 py-20 px-12 lg:w-full lg:pt-16'>
            ...
            <div className='flex flex-col items-center text-center gap-y-8 -mb-32'>
                <h1 className='lg:text-6xl text-4xl font-bold Capitalize -mt-2'>Lawyers</h1>
