...
const Header = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex max-lg:flex-col lg:justify-between lg:items-center mb-16 lg:mb-0 overflow-hidden scrollbar-hide">
        <nav className="flex flex-col gap-y-6 justify-center relative text-3xl lg:px-8 text-[#d4d5d6] font-bold cursor-pointer">
        ...
        <div className="flex flex-col gap-y-6 mt-12 mx-4 text-white">
          ...
          <Link href="/services" onClick={() => setMenuOpen(false)} className="hover:text-gray-400 block cursor-pointer p-3 h-[60px]">Services</Link>
          <a href="#" className="flex flex-col font-extrabold hover:text-white cursor-pointer leading-14 border-b-2 ease-in-out border-white pb-1">
